const exampleData = [
  ...
  },
  {
    cardName: 'Flamengo',
    cardDescription:
      'Essa carta concede a todos da Torcido do Flamengo'
      + 'um incremento de Raça e Ousadia',
    cardAttr1: 19,
    cardAttr2: 90,
    cardAttr3: 10,
    cardImage:
      'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSzFFyz02n1Qxwn9RNpcw2nqEEWTkTDAiebDg&usqp=CAU',
    cardTrunfo: false,
    cardRare: 'raro',
    optionalEmoji: '👺 👺',
  },
  {
    ...
    cardAttr2: '50',
    cardAttr3: '70',
    cardDescription: 'Força bruta soberana',
    cardImage:
      'https://art.ngfiles.com/images/41000/41964_ninjaco_sponge-bob-rumble.png?f1252084498',
    cardName: 'Bob Esponja Lutador',
    cardTrunfo: false,
    cardRare: 'muito raro',
    optionalEmoji: '🥊🥊🥊',
  },
